"""Model 1 -- the clinical baseline (#9).

The standard-of-care survival model using staging and pathology features only,
no molecular data. This is the benchmark every other model is measured against,
...
same decoder every model is scored through (#3 §3), fit directly on clinical
...
from .train import BaselineModelConfig, FoldResult, baseline_columns, run_all_folds, run_fold
